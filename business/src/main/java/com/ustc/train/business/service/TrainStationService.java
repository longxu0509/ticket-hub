...
import com.ustc.train.business.domain.TrainStationExample;
import com.ustc.train.business.mapper.TrainStationMapper;
import com.ustc.train.business.req.TrainStationQueryReq;
import com.ustc.train.business.req.TrainStationSaveReq;
import com.ustc.train.business.resp.TrainStationQueryResp;
...
public class TrainStationService {
    ...
    public PageResp<TrainStationQueryResp> queryList(TrainStationQueryReq req) {
        ...
        // 如果车次编码条件不为空 则SQL条件 在加上  and train_code = req.getTrainCode()
